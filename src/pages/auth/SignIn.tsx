      ...
      >
        <Card className="border-border/50 bg-surface/80 backdrop-blur-xl shadow-2xl">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardTitle className="text-2xl font-bold tracking-tight text-chalk uppercase">Welcome Back</CardTitle>
            <CardDescription className="text-mist">Enter your credentials to access your BLOC</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <div className="relative my-6 text-center text-xs uppercase tracking-widest text-border">
              <span className="relative z-10 bg-surface px-2">Or continue with</span>
          ...
          <CardFooter className="flex flex-wrap items-center justify-center gap-1 text-sm text-mist">
            ...
            <Link to="/signup" className="font-semibold text-amber hover:underline">Sign up for free</Link>
          </CardFooter>
        </Card>
      </motion.div>
    </div>
